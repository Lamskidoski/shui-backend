...
//         if (!username || !text || !createdAt) {
//             return sendError(400, 'Username, text, and createdAt are required fields.');
//         }
...
//     } catch (error) {
//         console.error('Update error:', error);
//         return sendError(500, `Error updating message: ${error.message}`); // Return error if update fails
//     }
// };
